<?php
session_start();
$_SESSION['current_page'] = "character-sheets.php";
...
<html>
  <head>
    <link rel="stylesheet" href="css/layoutCharacter-sheets.css">
  ...
  <body>
		...
		<ul id = components>
			<li id ="component1" class = "components">This is a character sheet component, press the + button to generate another (coming soon)</li>
